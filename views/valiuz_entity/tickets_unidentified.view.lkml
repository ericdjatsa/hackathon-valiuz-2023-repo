# The name of this view in Looker is "Tickets Unidentified"
view: tickets_unidentified {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `valiuz_entity.TICKETS_UNIDENTIFIED` ;;
  ...
  dimension: has_idclient_ens {
    type: string
    description: "Indicateur si le ticket possède un idclient_ens quand on le reçoit de l'enseigne"
    sql: ${TABLE}.HAS_IDCLIENT_ENS ;;
  }
