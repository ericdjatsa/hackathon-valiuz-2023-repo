# The name of this view in Looker is "Insee Carreau 1 Km 2019"
view: insee_carreau_1_km_2019 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `valiuz_opendata.INSEE_CARREAU_1KM_2019` ;;
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # This dimension will be called "I Est 1 Km" in Explore.
  ...
  dimension: id_carr1_km {
    type: string
    sql: ${TABLE}.ID_CARR1KM ;;
  }
